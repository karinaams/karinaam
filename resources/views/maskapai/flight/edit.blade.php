    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form action="{{ route('flight.update',$flight->id) }}" method="POST">
            ...
            <div class="form-control mt-3 flex flex-col">
                <label for="name">Airlines ID</label>
                <input type="text" class="input input-bordered w-full max-w-xs" name="airline_id" id="airline_id" value="{{ auth()->user()->airline_id }}" readonly>
            </div>
            <div class="form-control mt-3 flex flex-col">
